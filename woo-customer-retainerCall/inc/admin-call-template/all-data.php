...
<div class="wrap woocr_callCRM">
    <div id="crm-records">
            ...
            <div class="fields">
                <div class="items-top">
                    ...
                    <select v-model="filterCriteria.status">
                        ...
                        <option value="paid">رکورد های پرداخت شده</option>
                        <option value="notPaid">رکورد های پرداخت نشده</option>
                    </select>
        ...
        <table id="first_tableMain" v-else class="wp-list-table widefat fixed striped table-view-list">
            <thead>
            ...
            <tbody>
                <tr v-for="record in records" :key="record.id" :id="record.id" :class="
                    ...
                    <td class="textcenter" v-if="record.creditHolder">{{ record.creditHolderName }}<span class="hidden-creator-name">{{ record.creditHolder }}</span></td>
            ...
            <div class="modal-content">
                ...
                <div id="phase-details">
                    <div class="user_details">
                        ...
                        <p><strong>آخرین آپدیت ردیف</strong> {{ convertUnixToJalaali(modalrecord.date) }}</p>
                        <div class="flex">
                    ...
                    <div v-if="modalParrent.similarity.totalRecords > 1" class="similarities">
                        ...
                        <table id="second_tableSimilarity" class="wp-list-table text-center widefat fixed striped table-view-list">
                            <thead>
                                <tr class="text-center">
                                    <th width="5%">شناسه</th>
                                    <th>نام کاربر</th>
                                    ...
                                    <th width="35%">سفارشات ثبت شده</th>
                                </tr>
                            </thead>
                            <tbody>
            ...
            <div class="modal-content">
                ...
                <div id="phase-details">
                    <div class="user_details">
                        ...
                        <p><strong>تاریخ آخرین آپدیت:</strong> {{ convertUnixToJalaali(modalStatusData.retain_unix) }}</p>
